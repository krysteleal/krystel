...
export const FromFranceToValley = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F3F2F0] py-20 px-20 max-md:px-5">
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 text-[rgba(91,116,191,1)] mb-8 hover:opacity-80 transition-opacity"
      >
