...
export const Header: React.FC = () => {
  return (
    <header className="bg-[rgba(228,226,221,0.44)] backdrop-blur-sm flex w-full items-stretch gap-5 flex-wrap justify-between px-20 py-[39px] max-md:px-5 sticky top-0 z-50">
      <img
        loading="lazy"
        ...
        alt="Logo"
      />
      <nav className="flex gap-3.5 my-auto">
