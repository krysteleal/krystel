  ...
  return (
    <section id="journey" className="bg-[rgba(91,116,191,1)] w-full">
      <div className="max-w-[1440px] mx-auto flex flex-col items-center pl-5 pr-20 pt-[77px] pb-[163px] max-md:max-w-full max-md:pr-5 max-md:pb-[100px]">
        <div className="flex w-[945px] max-w-full items-center justify-center gap-5 max-md:text-[40px] max-md:text-left">
          <h2 className="neo-border neo-shadow bg-white p-6 transform rotate-1 text-[52px] text-neo-black font-vt323 font-bold max-md:max-w-full max-md:text-[40px]">
            Explore My Journey
          </h2>
        </div>
